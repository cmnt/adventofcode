...
const transformPuzzleToMatrice = (puzzle) => puzzle.reduce((matrice, line) => {
    if (!line.length) {
        matrice.push([]);
        return matrice;
    }
...
const getGroupDistinctAnswers = (groupAnswers) => groupAnswers.reduce((groupDistinctAnswers, personAnswers) => {
